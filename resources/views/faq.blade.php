...
<section id="faq">
    ...
    <div class="faq-list">
        <div class="container-fluid">
            <div class="row">
                <div class="col-xl-6 prima">
                    <h2>Prima del corso</h2>
                    <div class="faq-singola">
                        <h3 class="domanda">
                    ...
                    <div class="faq-singola">
                        ...
                        <p class="risposta">
                            Trovi tutte le informazioni sul prezzo nell'<a href="#">apposita sezione della pagina corso</a>
                        </p>
                    </div>
                </div>
                <div class="col-xl-6 dopo">
                    <h2>Dopo il corso</h2>
                    <div class="faq-singola">
                        <h3 class="domanda">
